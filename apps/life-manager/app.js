...
function exportCalendar(){
  ...
  const content=['BEGIN:VCALENDAR','VERSION:2.0','PRODID:-//Life Manager//EN','CALSCALE:GREGORIAN','METHOD:PUBLISH',events,'END:VCALENDAR'].join('\r\n');
